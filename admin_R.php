...
$sql = "INSERT INTO admin VALUES ('$id', '$admin_name', '$Email', '$password')";
...
<h1 style="color: orange; padding: 25px; text-align: center; font-size: 40px;">Admin Registration</h1>

<div class="main">
 <div class="container">
  <form action="admin_R.php" method="post" onSubmit="alert('Your account will be ready soon after verification');">
    ...
    <input type="text" id="fname" name="admin_name">
