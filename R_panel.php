  ...
  <nav>
    ...
    <div class="dropdown">
      ...
      <div id="myDropdown" class="dropdown-content">
        <a href="R_logout.php" title="Logout">Logout </a>
      </div>
    </div>
...
<h1 style="text-align: center; color: orange; padding:30px;">Restaurant Panel</h1>


<h1 style="text-align: center; color: orange; padding:30px;"> Welcome <?php echo $_SESSION["b_name"]; ?> </h1>
