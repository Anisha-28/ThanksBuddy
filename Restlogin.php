<?php
    ...
    if(count($_POST)>0) {
        ...
        $result = mysqli_query($conn,"SELECT * FROM restaurant WHERE email='" . $_POST["email"] . "' and pswd = '". md5($_POST["pswd"])."'");
...
<body>
  <nav>
   ...
   <div class="login-1">
        ...
        <div class="login-box">
            <h1 style="padding: 20px;"> Restaurant Login</h1>
